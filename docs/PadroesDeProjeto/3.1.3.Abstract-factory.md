...
export class CommonUserFactory implements UserFactory {
  ...
  createArt(): Art {
    throw new Error("Usuário comum não pode criar arte");
  }
...
| 1.4    | 01/06/2025 | Adição do código completos                                                                    | [Jésus Gabriel](https://github.com/xGabrielCv) [Alana Gabriele](https://github.com/alanagabriele) |             |                     |

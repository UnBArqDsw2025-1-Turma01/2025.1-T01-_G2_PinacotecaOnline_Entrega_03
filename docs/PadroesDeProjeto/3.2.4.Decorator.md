...
| ------ | ---------- | --------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | ----------------------- | ------------------- |
| 1.0    | 31/05/2025 | Criação do documento, adição da introdução e desenvolvimento. | [Davi Rodrigzues](https://github.com/DaviRogs) | [](https://github.com/) |                     |
| 1.1    | 31/05/2025 | Adição do Código a partir do diagrama feito, conclusão e bibliografia. | [Lucas Heler](https://github.com/Akaeboshi) | [](https://github.com/) |                     |
